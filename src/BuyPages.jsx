...
import { usePayments } from './components/PaymentContext';
...
const BuyPages = () => {
    ...
    const confirmPurchase = () => {
        ...
        const newPayment = {number: Number(pageNumber), price: totalPrice};
    ...
    const Pay = (index) => {
        const totalPages = pageLeft + Number(payments[index].number);
        setPageLeft(totalPages);

        setPayments(p => p.filter((_, i) => i != index));  
        
        alert(`Bạn Đã Thanh Toán Thành Công. Tổng Số Trang Mới: ${totalPages}.`);
    };
                    ...
                    {payments.map((payment, index) => (
                        <div className={styles.paymentBox}>
                            ...
                            <div className={styles.paymentButtonBox}>
                                <button onClick={() => Pay(index)} className={styles.payButton} >
                                    Thanh Toán
                                </button>
